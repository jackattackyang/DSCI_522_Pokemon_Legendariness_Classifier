...
knitr::opts_chunk$set(out.width = "70%", echo = FALSE)
library(tidyverse)
```
...
knitr::include_graphics("../results/cross_val_plot.png")
...
important_features = read_csv("../results/DecisionTree_important_features.csv")
