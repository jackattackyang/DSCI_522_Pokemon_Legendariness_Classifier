...
```{r intro logo}
# Logo taken from https://commons.wikimedia.org/wiki/File:International_Pok%C3%A9mon_logo.svg and is part of the public domain
knitr::include_graphics(here::here("imgs", "International_Pokémon_logo-wikimedia-cc.svg"))
```
...
"Flying", "Dragon" and "Psychic" types make up a disproportionate number of all legendaries. We would expect these types to play a role as legendary predictors.
