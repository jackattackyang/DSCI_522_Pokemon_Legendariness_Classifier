...
With more time available, we would test likely mis-classifications, add a "Gender" feature and attempt to improve the score of our model by identifying better features.
